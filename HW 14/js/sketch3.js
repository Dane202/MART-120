...
//OOP
var rect1Object, rect2Object, rect3Object;

function setup()
{
    createCanvas(1000, 600);
    rect1Object = new rectangle(200,150,30,30,150,75,85);
    rect2Object = new rectangle(500,300,50,20,75,120,45);
    rect3Object = new rectangle(700,450,45,55,63,45,150);
...
function createEnemy()
{
    //Enemy1 (Shape1)
    fill(10,150,80);
    rect(shape1X, shape1Y,40);

    //Enemy2 (Shape2)
    fill(90,40,80);
    rect(shape2X, shape2Y,50);

    //Enemy3 (Shape3)
    fill(20,100,150);
    rect(shape3X, shape3Y,60);
}
...
function winMessage()
{
    if(characterX > width && characterY > width-900)
    {
        ...
        stroke(5);
        textSize(55);
        text("Winner!", width/2-135, height/2-20);
    }
}